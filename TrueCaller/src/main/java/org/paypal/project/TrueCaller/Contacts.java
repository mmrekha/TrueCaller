...
public class Contacts {
	...
	public Contacts(int contact_id,int phone_book_id ,String contact_name,String contact_ph_no,String contact_description,String contact_location,Date created_time){
